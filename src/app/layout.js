...
export default function RootLayout({ children }) {
  return (
    <html className="h-full scroll-smooth bg-[#0a192f]">
      ...
      {/* Tried creating a grid layout, but it did not work! */}
      {/* <body className="w-screen">
        <CursorGlow />
        <div className="grid grid-cols-[700px_1fr] bg-[#0a192f] text-white">
          <aside className="p-5 w-full"><Navigation /></aside>
          <main
          className="pr-10 scroll-smooth max-w-[700px] flex flex-col items-center"
            id="content"
            >
              {children}
